...
class AppBarPreference extends StatelessWidget {
  final AppBarParams appBarParams;

  const AppBarPreference({
    Key? key,
    required this.appBarParams,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: appBarParams.height,
      decoration: BoxDecoration(
        color: getColor(context).primary,
        borderRadius: appBarParams.borderRadius,
      ),
      child: Row(
        children: [
          appBarParams.leading ?? Container(),
          Text(
            appBarParams.title,
          )
        ],
